package com.github.ren.s3.test;
...
public final class LocalFileOperation {
    ...
    public static List<File> chunkFile(String filePath, String chunkPath, long chunkSize) throws IOException {
    ...
    public static void mergeFile(List<File> files, File mergeFile) throws IOException {
        //合并文件
    ...
    static String testFile = "D:\\Users\\ykren\\Desktop\\test.exe";
    static int partSize = 1024*1024*5;
    public static void main(String[] args) throws IOException {
        System.out.println(new File(testFile).length());
        System.out.println(partSize);
        chunkFile(testFile,"chunks",partSize);
    }
}
